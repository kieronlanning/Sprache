...
public class Input : IInput {
	...
	public override int GetHashCode() {
		unchecked {
			return ((_source == null ? 0 : _source.GetHashCode()) * 397) ^ _position;
		}
	}

	/// <summary>
	/// Determines whether the specified <see cref="object"/> is equal to the current <see cref="Input" />.
	/// </summary>
	/// <returns>
	/// true if the specified <see cref="object"/> is equal to the current <see cref="Input" />; otherwise, false.
	/// </returns>
	...
	public bool Equals(IInput? other) {
		...
		return string.Equals(_source, other.Source, StringComparison.Ordinal) && _position == other.Position;
	}
